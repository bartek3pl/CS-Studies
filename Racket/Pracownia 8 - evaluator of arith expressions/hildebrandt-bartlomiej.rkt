...
(define proc
  '(let (x (lambda-rec (evall e)
                       (cond
                         [(pair? e)
                          (cond
                            [(eq? (car e) (quote +))
                             (+ (evall (car (cdr e))) (evall (car (cdr (cdr e)))))]
                            [(eq? (car e) (quote -))
                             (- (evall (car (cdr e))) (evall (car (cdr (cdr e)))))]
                            [(eq? (car e) (quote *))
                             (* (evall (car (cdr e))) (evall (car (cdr (cdr e)))))]
                            [(eq? (car e) (quote /))
                             (/ (evall (car (cdr e))) (evall (car (cdr (cdr e)))))])]
                         [true e])))
     (x (cons (quote /) (cons (cons (quote +) (cons 22 (cons 2 null))) ;;TEST
        (cons (cons (quote -) (cons 8 (cons (cons (quote *) (cons 4 (cons 4 null))) null))) null))))))
